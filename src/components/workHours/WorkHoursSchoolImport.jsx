...
export default function WorkHoursSchoolImport() {
    ...
    return (
        <>
            <Stack spacing={3}>
                <Stack direction={["column", "row"]} justifyContent="space-between" gap={2} alignItems="center">
                    <Typography variant="h6" fontWeight="bold">
                        Importar Horas de Trabajo - COLEGIO
                    </Typography>
            ...
            {workHourImportResponse.school && (
                <Stack sx={{ mt: 2, width: "100%", px: 0 }} direction={'column'}>
                    <List sx={{ width: "100%", px: 0 }}>
                        <ListItem sx={{ width: "100%", px: 0 }}>
                            <Alert severity="success" sx={{ width: "100%" }}>
                                <strong>TOTAL DE REGISTROS IMPORTADAS:</strong> {workHourImportResponse.school?.totalImported}
                            </Alert>                            
                        </ListItem>
                        <ListItem sx={{ width: "100%", px: 0 }}>
                            <Alert severity="error" sx={{ width: "100%" }}>
                                <strong>TOTAL DE REGISTROS NO IMPORTADAS:</strong> {workHourImportResponse.school?.totalSkipped}
                            </Alert>
                        </ListItem>
                        <ListItem sx={{ width: "100%", px: 0 }}>
                            <Alert severity="info" sx={{ width: "100%" }}>
                                <strong>DE UN TOTAL DE:</strong> {workHourImportResponse.school?.total}
                            </Alert>
                        </ListItem>
                    </List>
                </Stack>
